...
import static com.example.alilive_plugin.live.LivePushActivity.REQ_CODE_PUSH;
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    private void turnOnBitRateFps(boolean on)
    {
        if(!on)
        {
            ...
            mFpsText.setText(String.valueOf(AlivcFpsEnum.FPS_25.getFps()));
    ...
    private void initView() {
        ...
        mUrl.setText(PushAuth.getAuthUrl());
    }
