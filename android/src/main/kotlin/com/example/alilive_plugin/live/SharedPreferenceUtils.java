...
public class SharedPreferenceUtils {
    ...
    public static int getWhiteValue(Context context) {
        ...
        int white = sharedPreferences.getInt(WHITE, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_WHITE);
        return white;
    }
    ...
    public static int getBuffing(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int buffing = sharedPreferences.getInt(BUFFING, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_BUFFING);
        return buffing;
    }
    ...
    public static int getRuddy(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int ruddy = sharedPreferences.getInt(RUDDY, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_RUDDY);
        return ruddy;
    }
    ...
    public static int getBrightness(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int brightness = sharedPreferences.getInt(BRIGHTNESS, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_BRIGHTNESS);
        return brightness;
    }
    ...
    public static int getCheekpink(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int cheekpink = sharedPreferences.getInt(CHEEKPINK, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_CHEEKPINK);
        return cheekpink;
    }
    ...
    public static int getSlimFace(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int slimface = sharedPreferences.getInt(SLIMFACE, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_SLIMFACE);
        return slimface;
    }
    ...
    public static int getShortenFace(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int shortenface = sharedPreferences.getInt(SHORTENFACE, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_SHORTENFACE);
        return shortenface;
    }
    ...
    public static int getBigEye(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int bigeye = sharedPreferences.getInt(BIGEYE, AlivcLivePushConstants.DEFAULT_VALUE_INT_BEAUTY_BITEYE);
        return bigeye;
    }
    ...
    public static boolean isPreviewMirror(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        boolean previewMirror = sharedPreferences.getBoolean(PREVIEW_MIRROR, AlivcLivePushConstants.DEFAULT_VALUE_PREVIEW_MIRROR);
    ...
    public static boolean isPushMirror(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        boolean pushMirror = sharedPreferences.getBoolean(PUSH_MIRROR, AlivcLivePushConstants.DEFAULT_VALUE_PUSH_MIRROR);
        return pushMirror;
    }
    ...
    public static boolean isAutoFocus(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        boolean autoFocus = sharedPreferences.getBoolean(AUTOFOCUS, AlivcLivePushConstants.DEFAULT_VALUE_AUTO_FOCUS);
        return autoFocus;
    }
