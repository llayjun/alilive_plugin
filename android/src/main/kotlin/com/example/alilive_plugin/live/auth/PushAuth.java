package com.example.alilive_plugin.live.auth;
...
//    }
    ...
    public static void setAuthUrl(String authUrl) {
        PushAuth.authUrl = authUrl;
    }

    private static String getStreamName() {
        String streamName = null;
        SharedPreferences sharePref = AlilivePlugin.context.getSharedPreferences(PRE_GROUP, Context.MODE_PRIVATE);
        if (sharePref != null) {
